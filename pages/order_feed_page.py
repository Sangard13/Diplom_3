...
class OrderFeedPage(BasePage):
    ...
    def is_total_orders_counter_displayed(self):
        ...
        return self.is_element_visible(self.locators.TOTAL_ORDERS_COUNTER)
    ...
    def is_today_orders_counter_displayed(self):
        ...
        return self.is_element_visible(self.locators.TODAY_ORDERS_COUNTER)
    ...
    def get_in_progress_orders_list(self, timeout=5):
